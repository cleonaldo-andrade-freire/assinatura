...
import type { CertificateTemplate, Patient } from "@/lib/database.types";
import styles from "@/styles/shell.module.css";

export default async function NewCertificatePage({ searchParams }: { searchParams: { patientId?: string } }) {
