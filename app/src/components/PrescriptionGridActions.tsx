...
/** Ícones de Baixar/Reenviar por WhatsApp na linha da lista de prescrições —
 * mesmas rotas já usadas em PrescriptionActions.tsx (página de detalhe),
 * só que compactas pra caber no grid. */
export function PrescriptionGridActions({
  clinicId,
  prescriptionId,
  status,
  hasPhone,
  ...
  return (
    <div style={{ display: "flex", gap: 6, justifyContent: "flex-end" }}>
      <a
        href={`/api/prescriptions/download/${prescriptionId}`}
        target="_blank"
        rel="noreferrer"
